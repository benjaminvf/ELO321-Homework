...
void*  thread_rows(void*) ; /* se crean funciones para cada caso para revisar por separado rows,cols,Grid asi solo se necesitan 3 threads  */
...
pthread_create(&threadID[2], &attr[2],  &thread_grids , NULL );/* se chequea grids en este thread */
